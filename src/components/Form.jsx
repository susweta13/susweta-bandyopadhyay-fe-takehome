...
const Form = ({setResume, setLoading}) => {
    ...
    const initBrands = [{ id: 1, value: 'Plumber'}, { id: 2, value: 'Software Developer'}, { id: 3, value: 'Lawyer'}, { id: 4, value: 'Handyman'}];
            ...
            <Field>
                ...
                <label>
                    <InputRadio 
                        ...
                        name="plan"
                        value="basic"
                        checked={plan === 'General Liability'}
                        onChange={getData}
                    /> General Liability
                </label>
                <label>
                    <InputRadio 
                        ...
                        name="plan"
                        value="complete"
                        checked={plan === 'Professional Liability'}
                        onChange={getData}
                ...
                <label>
                    <InputRadio 
                        ...
                        name="plan"
                        value="complete"
                        checked={plan === 'Business Owners Policy'}
                        onChange={getData}
